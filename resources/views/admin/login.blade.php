            ...
            <div class="card-body login-card-body">
                ...
                <form action="{{ route('admin.auth') }}" method="post">
                    ...
                    <div class="input-group mb-3">
                        <input type="email" name="email" class="form-control" placeholder="Email" value="{{ old('email') }}"> <!-- Prefill email -->
                    ...
                    @if($errors->has('email'))
                    <p class="help-block text-danger"> <!-- Add Bootstrap danger class for better visibility -->
                        {{ $errors->first('email') }}
                    </p>
                    @endif
                    <div class="input-group mb-3">
                        <input type="password" name="password" class="form-control" value="{{ old('email') }}" placeholder="Password">
                        <div class="input-group-append">
                            <div class="input-group-text">
