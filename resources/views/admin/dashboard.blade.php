...
<body class="hold-transition sidebar-mini layout-fixed">
    ...
    <script src="{{asset('admin_assts/assets/plugins/jquery/jquery.min.js')}}"></script>

    <script src="{{asset('admin_assts/assets/plugins/bootstrap/js/bootstrap.bundle.min.js')}}"></script>

    <script src="{{asset('admin_assets/assets/js/adminlte.min.js?v=3.2.0')}}"></script>
    <!-- Summernote -->
    <script src="{{asset('admin_assts/assets/plugins/summernote/summernote-bs4.min.js')}}"></script>
</body>
